...
import { Quote, QuoteTeamMember } from '../types';

const styles = StyleSheet.create({
  page: { padding: 40, fontSize: 10, fontFamily: 'Helvetica' },
  header: { marginBottom: 20, borderBottom: '2 solid #2563eb', paddingBottom: 15 },
  title: { fontSize: 20, fontWeight: 'bold', color: '#2563eb' },
  subtitle: { fontSize: 10, color: '#64748b', marginTop: 4 },
  section: { marginBottom: 15 },
  sectionTitle: { fontSize: 12, fontWeight: 'bold', marginBottom: 8, color: '#1e293b', borderBottom: '1 solid #e2e8f0', paddingBottom: 4 },
  row: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 3 },
  label: { color: '#64748b' },
  value: { fontWeight: 'bold' },
  table: { marginTop: 8 },
  tableHeader: { flexDirection: 'row', backgroundColor: '#f1f5f9', padding: 6, borderBottom: '1 solid #e2e8f0' },
  tableRow: { flexDirection: 'row', padding: 6, borderBottom: '1 solid #f1f5f9' },
  col1: { width: '35%' },
  ...
  footer: { position: 'absolute', bottom: 30, left: 40, right: 40, textAlign: 'center', fontSize: 8, color: '#94a3b8', borderTop: '1 solid #e2e8f0', paddingTop: 8 },
  badge: { backgroundColor: '#dbeafe', color: '#1d4ed8', padding: '3 8', borderRadius: 4, fontSize: 9 },
  bigPrice: { fontSize: 18, fontWeight: 'bold', color: '#2563eb', marginTop: 4 },
  policies: { fontSize: 8, color: '#64748b', marginTop: 10, lineHeight: 1.4 },
});
